    ...
    <div class="goBack">
      ...
      >
        <pagcomp
          ...
          :pag="currentpage"
          :search="cerca"
          v-model="paginetotali"
          :key="currentpage + cerca"
        ></pagcomp>
      </div>
